...
router.get('/likes', async (req, res) => {
  ...
  // 🔎 Função para pegar info do jogador
  ...
  try {
    // 2️⃣ Envia mensagem no grupo
    await client.sendMessage(-1002208588695, { message: `/likes ${id}` });
    console.log(`✅ Mensagem enviada para o grupo: /likes ${id}`);

    // 3️⃣ Espera 2 segundos
    await new Promise(resolve => setTimeout(resolve, 2000));

    // 4️⃣ Pega os likes depois

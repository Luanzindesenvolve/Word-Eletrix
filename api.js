...
(async () => {
  const { yts, ytmp4, ytmp3, alldl, ai } = await ytdl;

  const res = await yts("Alan Walker");
  console.log(res);
})();
...
(async () => {
  const { ytmp3: play, ytmp4: clipe } = await ytScraper;

  const mp3 = await play("https://www.youtube.com/watch?v=xxxx");
  console.log("MP3:", mp3);

  const mp4 = await clipe("https://www.youtube.com/watch?v=xxxx");
  console.log("MP4:", mp4);
})();

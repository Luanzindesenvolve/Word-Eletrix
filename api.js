...
router.get('/ufc', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.gg/categoria/ufc-ao-vivo/';
...
router.get('/basquete', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.gg/categoria/categoria/nba-ao-vivo//';
    const { data } = await axios.get(siteUrl);
...
router.get('/nfl', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.gg/categoria/nfl-ao-vivo/';
    const { data } = await axios.get(siteUrl);
 ...
 router.get('/ucl', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.gg/categoria/champions-league-ao-vivo/';
    const { data } = await axios.get(siteUrl);
...
router.get('/brasileirao', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.gg/categoria/brasileiro-ao-vivo/';
    const { data } = await axios.get(siteUrl);
...
router.get('/tv', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.gg/categoria/tv-online/';
    const { data } = await axios.get(siteUrl);
...
router.get('/esportedodia', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.gg/categoria/esportes-ao-vivo/';
    const { data } = await axios.get(siteUrl);
...
router.get('/futebol', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.gg/categoria/futebol-ao-vivo/';
    const { data } = await axios.get(siteUrl);

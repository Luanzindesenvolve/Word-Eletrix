...
router.get('/assistir', async (req, res) => {
  ...
  const searchUrl = `https://multicanais.br.com/?s=${encodeURIComponent(query)}`;
  try {
...
router.get('/jogosdodia', async (req, res) => {
  try {
    const { data } = await axios.get('https://multicanais.br.com/');
    const $ = cheerio.load(data);
    const jogos = [];
...
router.get('/ufc', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.br.com/categoria/ufc-ao-vivo/';
...
router.get('/bbb25', (req, res) => {
  const resultado = [
    "https://multicanais.br.com/assistir-bbb-ao-vivo-online-24-horas/",
...
router.get('/basquete', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.br.com/categoria/categoria/nba-ao-vivo//';
    const { data } = await axios.get(siteUrl);
...
router.get('/nfl', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.br.com/categoria/nfl-ao-vivo/';
    const { data } = await axios.get(siteUrl);
 ...
 router.get('/ucl', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.br.com/categoria/champions-league-ao-vivo/';
    const { data } = await axios.get(siteUrl);
...
router.get('/brasileirao', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.br.com/categoria/brasileiro-ao-vivo/';
    const { data } = await axios.get(siteUrl);
...
router.get('/tv', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.br.com/categoria/tv-online/';
    const { data } = await axios.get(siteUrl);
...
router.get('/esportedodia', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.br.com/categoria/esportes-ao-vivo/';
    const { data } = await axios.get(siteUrl);
...
router.get('/futebol', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.br.com/categoria/futebol-ao-vivo/';
    const { data } = await axios.get(siteUrl);

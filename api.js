...
router.get('/iframe', async (req, res) => {
  ...
  try {
    // Headers simulando um navegador
    const headers = {
      'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/117.0.0.0 Safari/537.36',
      'Accept-Language': 'pt-BR,pt;q=0.9,en-US;q=0.8,en;q=0.7',
      'Sec-CH-UA': '"Chromium";v="117", "Google Chrome";v="117", "Not;A=Brand";v="8"',
      'Sec-CH-UA-Mobile': '?0',
      'Sec-CH-UA-Platform': '"Windows"',
      // Se quiser, pode adicionar outros Sec-CH-UA-* aqui
    };

    const { data } = await axios.get(canalUrl, { headers });
    const $ = cheerio.load(data);

...
router.get('/likes', async (req, res) => {
  ...
  // Pega informações antes do envio usando API antiga
  ...
  // Pega informações depois do envio usando API nova
    ...
    const handleResponse = new Promise((resolve, reject) => {
      ...
      const eventHandler = async (event) => {
        try {
          ...
          // Consulta nova API após a resposta do grupo
          const infoDepois = await getUserInfoDepois();
          if (!infoDepois) {

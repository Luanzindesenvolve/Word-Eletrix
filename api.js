    ...
    const handleResponse = new Promise((resolve, reject) => {
      ...
      const eventHandler = async (event) => {
        try {
          ...
          // Se for a primeira mensagem recebida, guarda e responde ela
          if (!primeiraMensagem) {
            primeiraMensagem = message;
            await client.sendMessage(grupoChatId, { message: primeiraMensagem });
            console.log('Respondendo primeira mensagem recebida:', primeiraMensagem);
          }
          ...
          if (step === 0 && message.includes('Por favor, envie o UID do jogador')) {
            ...
            console.log('Quantidade enviada: 300');
            step++;

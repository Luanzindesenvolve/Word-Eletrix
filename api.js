...
router.get('/jogosdodia', async (req, res) => {
  try {
    const { data } = await axios.get('https://multicanais.black/');
    const $ = cheerio.load(data);
    const jogos = [];
...
router.get('/ufc', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.black/assistir/ufc-ao-vivo/';
...
router.get('/basquete', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.black/assistir/basquete-ao-vivo/';
    const { data } = await axios.get(siteUrl);
...
router.get('/nfl', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.black/assistir/nfl-ao-vivo/';
    const { data } = await axios.get(siteUrl);
 ...
 router.get('/ucl', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.black/assistir/champions-league-ao-vivo/';
    const { data } = await axios.get(siteUrl);
...
router.get('/brasileirao', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.black/assistir/brasileiro-ao-vivo/';
    const { data } = await axios.get(siteUrl);
...
router.get('/tv', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.black/assistir/tv-online/';
    const { data } = await axios.get(siteUrl);
...
router.get('/esportedodia', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.black/assistir/esportes-ao-vivo/';
    const { data } = await axios.get(siteUrl);
...
router.get('/futebol', async (req, res) => {
  try {
    const siteUrl = 'https://multicanais.black/assistir/futebol-ao-vivo/';
    const { data } = await axios.get(siteUrl);
